param(
[string]$Lhost="127.0.0.2",[string]$Lport="4444",[switch]$web,[string]$netcat,[switch]$python,[switch]$python3,[string]$bash,[switch]$perl,[switch]$php,[switch]$ruby,[switch]$java,[switch]$xterm,[switch]$socat,[switch]$metasploit,[switch]$PowershellICMP,[switch]$PowershellTCP,[switch]$PowershellUDP
)
